...
export function DadosEstadoSocialInsalt() {
    ...
    return (
        <FormSection title="SOBRE O ESTADO SOCIAL">
            <FormRow>
                <FormColumn span={6} >
                    ...
                    <FormColumn span={8} className={classNamesSubSection}>
                        <FormTextArea name="social.motivos_rua" label="Há quanto tempo e por quê?" disabled={!values.social?.situacao_rua} />
                    </FormColumn>
                </FormColumn>
                <FormColumn span={6} >
                    <FormCheckbox name="social.outros_centros" label="Já passou por outro Centro de Recuperação antes" />
                    <FormColumn span={8} className={classNamesSubSection}>
                        <FormTextArea name="social.nome_outros_centros" label="Qual?" disabled={!values.social?.outros_centros} />
                    </FormColumn>
                    <FormColumn span={8} className={classNamesSubSection}>
                        <FormTextArea name="social.motivo_saida_outros_centros" label="Por quanto tempo e por que saiu?" disabled={!values.social?.outros_centros} />
                    </FormColumn>
                </FormColumn>
            </FormRow>
            <FormRow>
                <FormColumn span={4}>
                    <FormTextArea name="social.chegada_missao_vida" label="Como chegou a Missão Vida?" />
                </FormColumn>
                <FormColumn span={4}>
            ...
            <FormRow>
                <FormColumn span={6}>
                    <FormTextArea name="social.sentimentos" label="Como se sente na situação em que você se encontra?" />
                </FormColumn>
                <FormColumn span={6}>
                    <FormTextArea name="social.objetivos" label="Quais são os seus objetivos como acolhido na Missão Vida?" />
                </FormColumn>
            </FormRow>
        </FormSection>
