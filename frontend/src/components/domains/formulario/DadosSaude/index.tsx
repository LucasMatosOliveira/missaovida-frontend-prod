        ...
        <FormSection title="DADOS DE SAÚDE DO ACOLHIDO">
            <FormRow>
                ...
                <FormColumn span={6} >
                    ...
                    <FormColumn span={8} className={classNamesSubSection}>
                        <FormTextArea name="saude.descricao_psicotropico" label="Qual e por quê?" disabled={!values.saude?.medicamento_psicotropico} />
                    </FormColumn>
                </FormColumn>
            </FormRow>
            <FormRow>
                <FormColumn span={6} >
                    ...
                    <FormColumn span={8} className={classNamesSubSection}>
                        <FormTextArea name="saude.descricao_uso_continuo" label="Qual?" disabled={!values.saude?.medicamento_uso_continuo} />
                    </FormColumn>
                </FormColumn>
                <FormColumn span={6} >
                    <FormCheckbox name="saude.lesao_fisica" label="Já sofreu alguma lesão física" />
                    <FormColumn span={8} className={classNamesSubSection}>
                        <FormTextArea name="saude.local_lesao_fisica" label="Em qual dos membros?" disabled={!values.saude?.lesao_fisica} />
                    </FormColumn>
                </FormColumn>
            </FormRow>
            <FormRow>
            ...
            <FormRow>
                <FormColumn span={6} >
                    ...
                    <FormColumn span={8} className={classNamesSubSection}>
                        <FormTextArea name="saude.nome_alergia_medicamento" label="Nome do medicamento" disabled={!values.saude?.alergia_medicamentos} />
                    </FormColumn>
                </FormColumn>
                <FormColumn span={4} >
                    <FormCheckbox name="saude.alguma_doenca" label="Apresenta alguma doença" />
                    <FormColumn span={8} className={classNamesSubSection}>
                        <FormTextArea name="saude.nome_doenca" label="Qual doença?" disabled={!values.saude?.alguma_doenca} />
                    </FormColumn>
                </FormColumn>
            </FormRow>
            <FormRow>
