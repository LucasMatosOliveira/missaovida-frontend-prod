        ...
        <FormSection title="QUAIS SÃO AS SUBSTÂNCIAS PSICOATIVAS DO SEU USO">
            <FormRow>
                <FormColumn span={6} >
                    ...
                    <FormColumn span={8} className={classNamesSubSection}>
                        <FormTextArea name="substancia.motivo_alcool" label="O que levou você a fazer o uso, com que idade e por quê?" disabled={!values.substancia?.uso_alcool} />
                    </FormColumn>
                </FormColumn>
                <FormColumn span={6} >
            ...
            <FormRow>
                <FormColumn span={6} >
                    ...
                    <FormColumn span={8} className={classNamesSubSection}>
                        <FormTextArea name="substancia.motivo_outras_substancias" label="O que te levou a fazer uso da(s) substância(s)?" disabled={!values.substancia?.outras_substancias} />
                    </FormColumn>
                </FormColumn>
            </FormRow>
        </FormSection>
