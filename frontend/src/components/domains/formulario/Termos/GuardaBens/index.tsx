    ...
    return (
        <FormSection title="TERMO DE GUARDA DE BENS E DOCUMENTOS">
            <div className="page-teste">
                ...
                <FormRow>
                    <FormColumn span={12}>
                        <FormTextArea name="guarda.documentos_guardados" label="Quais documentos serão guardados?" />
                    </FormColumn>
                </FormRow>
                <FormRow>
                    <FormColumn span={4}>
                ...
                <FormRow>
                    <FormColumn span={12}>
                        <FormTextArea name="guarda.outros_objetos" label="Outros objetos de valor apresentados:" />
                    </FormColumn>
                </FormRow>
            </div>
        </FormSection>
